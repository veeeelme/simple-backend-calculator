...
global_choice = input(
    'Вычисления чего вы хотите? ч - числа/ гф - геометр. фигуры: ')
...
try:
    ...
    if global_choice == 'гф':
        ...
        if choice == 'п':
            choice_for_type = input(
                "Периметр или площадь?; площадь/периметр: ")
            a = int(input('Введите длину: '))
            b = int(input('Введите ширину: '))
            if choice_for_type == 'периметр':
                funcs.perimetr_rectangle(a, b)
            if choice_for_type == 'площадь':
                funcs.area_rectangle(a, b)

        if choice == 'к':
            choice_for_type = input(
                "Периметр или площадь?; периметр/площадь: ")
            a = int(input('Введите длину стороны: '))
            if choice_for_type == 'периметр':
                funcs.perimetr_square(a)
            if choice_for_type == 'площадь':
                funcs.area_square(a)
        ...
        if choice == 'т':
            ...
            funcs.periment_triangle(a, b, c)

        if choice == 'пара':
            choice_for_type = input(
                'Периметр или площадь?; периметр/площадь/объём: ')
            print("Введите три ребра: ")
            a = int(input('Введите a: '))
            b = int(input('Введите b: '))
            c = int(input('Введите c: '))
            if choice_for_type == 'площадь':
                funcs.surface_area_parallelepiped(a, b, c)
            if choice_for_type == 'периметр':
                funcs.perimetr_parallelepiped(a, b, c)
            if choice_for_type == 'объём':
                funcs.volume_of_parallelepiped(a, b, c)
